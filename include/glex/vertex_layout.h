...
public:
    ...
    ///
    /// @returns `VertexLayout` object wrapped in `std::unique_ptr` if successful, or `nullptr` if initialization fails.
    ...
    ///
    /// @param attrib_index: The index of the vertex attribute.
    /// @param count: The number of components per vertex attribute.
    ...
    ///
    /// @param attrib_index: The index of the vertex attribute to disable.
